...
using NETSikuliClient.Sikuli_JSON;
...
{
	/// <summary>
	/// Description of Screen. This project depends on a running Sikuli Server at the given endpoint!
	/// </summary>
	public class Screen
	{
        ...
        {
            serviceURL = "http://localhost:" + port.ToString() + "/sikuli/api/";
        }

        public Screen(string host, int port)
        {
            serviceURL = "http://" + host + ":" + port.ToString() + "/sikuli/api/";
        }
